...
(defun my/preset-gpg-passphrase ()
  ...
  (let* ((passphrase (string-trim (shell-command-to-string "pass show system/gpg/passphrase")))
         ...
         (keygrip "5CF9AC663BD872DC6A0CE65F25DCBB86AE33171B"))
...
(defun my/spotifyd-start ()
  ...
  (message "Spotifyd started - device: phatle-NixOS"))
...
(map! :leader
      ...
      ;; ─── SPOTIFY (Smudge) - Primary/Top Level ───
      ...
      ;; ─── DOWNLOADS - Nested ───
      (:prefix ("y" . "download") ;; Changed to 'y' for 'youtube-dl/yt-dlp' style, or keep 'l'
