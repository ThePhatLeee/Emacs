...
alias syncrev="rsync -avz --delete '/home/phatle/Revere/Revere LATEST/' '/mnt/nomad/TrueNAS/Revere/Revere LATEST/'"
alias mntnas="sshfs phatle@172.18.250.13:/mnt/Vault /mnt/Logos"
...
alias nrs-empirica="nixos-rebuild switch --flake .#empirica --target-host phatle@192.168.0.28 --sudo"
alias ns="nh search"
...
alias logos="mosh phatle@logos -- tmux new-session -A -s main"
...
# pnpm
export PNPM_HOME="/home/phatle/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# fi
# if ! ssh-add -l 2>/dev/null | grep -q "phatle@phatleblais.com"; then
...
#   ssh-add ~/.ssh/empire.key
# fi
# if ! ssh-add -l 2>/dev/null | grep -q "josh@phatleblais.com"; then
#   ssh-add ~/.ssh/id_ed25519
# fi
