...
(defvar my-microblog-json-path "~/Development/phatleblais.com/src/content/notes/notes.json"
  "Path to the microblog JSON file.")

(defvar my-microblog-images-dir "~/Development/phatleblais.com/public/images/microblog/"
