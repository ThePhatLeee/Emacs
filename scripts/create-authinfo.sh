...
PRIMARY_EMAIL=$(pass show email/gmail-personal/address 2>/dev/null || echo "")
...
# IRC - Libera Chat
# ============================================================================
IRC_SERVER=$(pass show services/irc/server 2>/dev/null || echo "")
IRC_NICK=$(pass show services/irc/nick 2>/dev/null || echo "")
IRC_PASSWORD=$(pass show services/irc/password 2>/dev/null || echo "")
...
# Matrix
# ============================================================================
MATRIX_HOMESERVER=$(pass show services/matrix/homeserver 2>/dev/null || echo "")
MATRIX_USERNAME=$(pass show services/matrix/username 2>/dev/null || echo "")
MATRIX_TOKEN=$(pass show services/matrix/token 2>/dev/null || echo "")
...
# ============================================================================
# Email 1: Gmail Personal (jokinenmarko1@gmail.com)
# ============================================================================
GMAIL_ADDRESS=$(pass show email/gmail-personal/address 2>/dev/null || echo "")
GMAIL_PASSWORD=$(pass show email/mail-personal/app-password 2>/dev/null || \
                 pass show email/gmail-personal/app-password 2>/dev/null || echo "")
...
# ============================================================================
# Email 2: Proton Personal (jokinen.marko@proton.me) - Bridge
# ============================================================================
PROTON_PERSONAL_ADDRESS=$(pass show email/proton-personal/address 2>/dev/null || echo "")
PROTON_PERSONAL_PASSWORD=$(pass show email/proton-personal/bridge-password 2>/dev/null || echo "")
...
# ============================================================================
# Email 3: Proton PM Alias (jokinen.marko@pm.me) - Bridge
# ============================================================================
PROTON_PM_ADDRESS=$(pass show email/proton-pm-alias/address 2>/dev/null || echo "")
PROTON_PM_PASSWORD=$(pass show email/proton-pm-alias/bridge-password 2>/dev/null || echo "")
...
# ============================================================================
# Email 4: Proton Developer (thephatle@proton.me) - Bridge
# ============================================================================
PROTON_DEV_ADDRESS=$(pass show email/proton-developer/address 2>/dev/null || echo "")
PROTON_DEV_PASSWORD=$(pass show email/proton-developer/bridge-password 2>/dev/null || echo "")
...
# ============================================================================
# Email 5: Company (info@thephatle.dev) - Proton Bridge!
# ============================================================================
COMPANY_ADDRESS=$(pass show email/company/address 2>/dev/null || echo "")
COMPANY_PASSWORD=$(pass show email/company/bridge-password 2>/dev/null || echo "")
...
# ============================================================================
# Email 6: Work NW Group (cto@nwgroup.asia)
# ============================================================================
WORK_ADDRESS=$(pass show email/work-nwgroup/address 2>/dev/null || echo "")
WORK_PASSWORD=$(pass show email/work-nwgroup/password 2>/dev/null || echo "")
WORK_SMTP=$(pass show email/work-nwgroup/smtp-server 2>/dev/null || echo "")
WORK_IMAP=$(pass show email/work-nwgroup/imap-server 2>/dev/null || echo "")
...
EOF
    if [ -n "$WORK_SMTP" ]; then
        cat >> ~/.authinfo << EOF
# SMTP
machine $WORK_SMTP login $WORK_ADDRESS port 587 password $WORK_PASSWORD
EOF
    fi
    if [ -n "$WORK_IMAP" ]; then
        cat >> ~/.authinfo << EOF
# IMAP
machine $WORK_IMAP login $WORK_ADDRESS port 993 password $WORK_PASSWORD
EOF
    fi
...
if gpg --list-keys "$PRIMARY_EMAIL" &>/dev/null; then
    ...
    echo "  • 6 Email accounts (1 Gmail + 4 Proton Bridge + 1 Work)"
    echo ""
